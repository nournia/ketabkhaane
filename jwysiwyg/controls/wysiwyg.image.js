	...
	$.wysiwyg.controls.image = {
		...
		init: function (Wysiwyg) {
			...
			formImageHtml = 		'<form class="wysiwyg" id="wysiwyg-addImage"><fieldset>' +
									'<div class="form-row"><span class="form-row-key">{preview}:</span><div class="form-row-value"><img id="browseImage" src=""/></div></div>'+
									...
									'<div class="form-row form-row-last"><label for="name"></label><div class="form-row-value"><input type="submit" class="button" value="{submit}"/><input type="reset" class="button" value="{reset}"/></div></div>' +
									'</fieldset></form>';
